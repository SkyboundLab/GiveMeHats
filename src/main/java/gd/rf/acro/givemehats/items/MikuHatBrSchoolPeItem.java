...
public class MikuHatBrSchoolPeItem extends TrinketItem implements TrinketRenderer {
    public MikuHatBrSchoolPeItem(Item.Settings settings) {
        super(settings);
    }
    ...
    public void appendTooltip(ItemStack stack, World world, List<Text> tooltip, TooltipContext context) {
        ...
        tooltip.add(Text.translatable("text.miku_hat_br_school_pe"));
    }
