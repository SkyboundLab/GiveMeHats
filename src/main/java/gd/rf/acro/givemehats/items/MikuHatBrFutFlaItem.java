...
public class MikuHatBrFutFlaItem extends TrinketItem implements TrinketRenderer {
    public MikuHatBrFutFlaItem(Item.Settings settings) {
        super(settings);
    }
    ...
    public void appendTooltip(ItemStack stack, World world, List<Text> tooltip, TooltipContext context) {
        ...
        tooltip.add(Text.translatable("text.miku_hat_br_fut_fla"));
    }
