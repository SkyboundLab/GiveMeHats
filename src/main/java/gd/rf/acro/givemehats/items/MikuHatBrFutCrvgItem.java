...
public class MikuHatBrFutCrvgItem extends TrinketItem implements TrinketRenderer {
    public MikuHatBrFutCrvgItem(Item.Settings settings) {
        super(settings);
    }
    ...
    public void appendTooltip(ItemStack stack, World world, List<Text> tooltip, TooltipContext context) {
        ...
        tooltip.add(Text.translatable("text.miku_hat_br_fut_crvg"));
    }
