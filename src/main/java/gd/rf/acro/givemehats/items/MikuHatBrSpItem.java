...
public class MikuHatBrSpItem extends TrinketItem implements TrinketRenderer {
    public MikuHatBrSpItem(Item.Settings settings) {
        super(settings);
    }
    ...
    public void appendTooltip(ItemStack stack, World world, List<Text> tooltip, TooltipContext context) {
        ...
        tooltip.add(Text.translatable("text.miku_hat_br_sp"));
    }
