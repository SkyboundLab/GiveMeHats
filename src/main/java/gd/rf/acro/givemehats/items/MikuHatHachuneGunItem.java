...
public class MikuHatHachuneGunItem extends TrinketItem implements TrinketRenderer {
    public MikuHatHachuneGunItem(Item.Settings settings) {
        super(settings);
    }
    ...
    public void appendTooltip(ItemStack stack, World world, List<Text> tooltip, TooltipContext context) {
        ...
        tooltip.add(Text.translatable("text.miku_hat_hachune_gun"));
    }
