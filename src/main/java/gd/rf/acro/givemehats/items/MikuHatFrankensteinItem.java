...
public class MikuHatFrankensteinItem extends TrinketItem implements TrinketRenderer {
    public MikuHatFrankensteinItem(Item.Settings settings) {
        super(settings);
    }
    ...
    public void appendTooltip(ItemStack stack, World world, List<Text> tooltip, TooltipContext context) {
        ...
        tooltip.add(Text.translatable("text.miku_hat_frankenstein"));
    }
